module.exports = {
    handle: function (req, res, prev, cfg) {
        // this function will be call after main handle for each request
    },
    ...
    // true if this backware called for all services, except except for the router configured not
    global: false,
